...
public class EditBooking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActionBar.setTitle("Edit Booking");

        myBooked_list = (ListView) findViewById(R.id.myBooked_list);

        final ProgressDialog progressDialog = new ProgressDialog(EditBooking.this,
        ...
        FirebaseDatabase.getInstance().getReference().child("Booking").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                myBooked_list.setAdapter(new com.conor.aughergaa.Adapters.MyBooking(myBooks,EditBooking.this,1));
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                progressDialog.dismiss();
                Toast.makeText(EditBooking.this, ""+databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
