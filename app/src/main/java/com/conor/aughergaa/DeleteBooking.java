...
public class DeleteBooking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActionBar.setTitle("Delete Booking");

        myBooked_list = (ListView) findViewById(R.id.myBooked_list);

        final ProgressDialog progressDialog = new ProgressDialog(DeleteBooking.this,
        ...
        FirebaseDatabase.getInstance().getReference().child("Booking").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                myBooked_list.setAdapter(new com.conor.aughergaa.Adapters.MyBooking(myBooks,DeleteBooking.this,2));
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                progressDialog.dismiss();
                Toast.makeText(DeleteBooking.this, ""+databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
